...
class PDFInfo(object):
    ...
    def __init__(self, title=None, author=None, subject=None):
        ...
        self.creator = 'Smart Quail (https://ciciapp.com/pyinvoice)'
...
class AddressInfo(object):
    def __init__(self, name=None, provider=None,street=None, city=None, state=None, country=None, post_code=None,email=None):
        """
...
class ServiceProviderInfo(AddressInfo):
    ...
    def __init__(self, name=None, street=None, city=None, state=None, country=None, post_code=None,
                 vat_tax_number=None,email=None):
        """
        :type name: str or unicode or None
        :type street: str or unicode or None
        :type city: str or unicode or None
        ...
        """
        super(ServiceProviderInfo, self).__init__(name, street, city, state, country, post_code,email)
...
class ClientInfo(AddressInfo):
    ...
    """
    def __init__(self, name=None, provider=None, city=None, state=None, country=None, post_code=None,
        ...
        """
        super(ClientInfo, self).__init__(name, provider, city, state, country, post_code)
        self.email = email
